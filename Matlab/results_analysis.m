% import
ffm = importdata('../outputs/FastFreakMatches.csv');
sfm = importdata('../outputs/SiftMatches.csv');
...
% find fit and RMS at fit, at the same time
...
% calculate bad pixels from scaled version
...
%% do analysis of bad pixels vs. disparity threshold 
d = zeros(1,100);
for i=100:-1:1
